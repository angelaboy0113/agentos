...
export async function executeJob(job, config, emit) {
  ...
  const rawResult = assessInvestigation(job, preserveAnalysisGaps(job, preserveEnvironmentEvidence(job, generated)));
  if (sourceSync) {
